...
/*
  ...
  Encryption:
  The Hill cipher uses matrix multiplication to encrypt blocks of text.
  C = K * P (mod 26)
  ...
  Implementation:
  Text is converted to numeric values (A=0, B=1, ..., Z=25)
  For a 2x2 key matrix, plaintext is processed in digraphs (pairs)
  The determinant must be coprime with 26 for decryption to be possible
  Matrix operations are performed in modulo 26 arithmetic
